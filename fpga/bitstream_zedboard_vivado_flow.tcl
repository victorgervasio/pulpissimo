...
#####fpga/pulpissimo-zedboard/Makefile##########################################################################################################################################################
...
#########fpga/pulpissimo-zedboard/tcl/run.tcl##########################################################################################################################################################
        source tcl/common.tcl
#############fpga/pulpissimo-zedboard/tcl/common.tcl##########################################################################################################################################################
            # detect board
...
#############fpga/pulpissimo/tcl/ips_inc_dirs.tcl####################################################################################################################
...
#############fpga/pulpissimo/tcl/ips_src_files.tcl#################################################################################
            if ![info exists PULP_FPGA_SIM] {
                set RTL /home/victor/pulp_box/pulpissimo/rtl
                set IPS /home/victor/pulp_box/pulpissimo/ips
                set FPGA_IPS ../ips
                set FPGA_RTL ../rtl
            }
...
#############fpga/pulpissimo/tcl/ips_add_files.tcl##############################################################################################################
...
#############fpga/pulpissimo/tcl/rtl_src_files.tcl###################################################################################################################
            if ![info exists PULP_FPGA_SIM] {
                set RTL /home/victor/pulp_box/pulpissimo/rtl
                set IPS /home/victor/pulp_box/pulpissimo/ips
                set FPGA_IPS ../ips
...
#############fpga/pulpissimo/tcl/rtl_add_files.tcl#############################################################################################################
